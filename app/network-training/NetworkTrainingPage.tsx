// app/network-training/NetworkTrainingPage.tsx
"use client";
...
import { courses, benefits, technologies } from "./data";
...
const NetworkTrainingPage: React.FC = React.memo(() => {
  return (
    <Box
      sx={{
      ...
      <Box sx={{ py: 10, backgroundColor: "white" }}>
        <Container maxWidth="xl">
          ...
          <Grid container spacing={4}>
            ...
            <Grid size={{ xs: 12, md: 4 }}>
              <BenefitCard>
                <WifiIcon sx={{ fontSize: 50, color: "#d32f2f", mb: 2 }} />
                <Typography variant="h5" gutterBottom sx={{ fontWeight: 600 }}>
        ...
        <Container maxWidth="xl">
          <Box sx={{ textAlign: "center", mb: 8 }}>
            ...
            <Typography
              ...
              sx={{ maxWidth: 800, mx: "auto" }}
            >
              Learn cutting-edge networking technologies and tools used in
            ...
            {technologies.map((tech, index) => (
              <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }} key={index}>
                ...
                >
                  ...
                  >
                    <DesignServicesIcon sx={{ color: "#d32f2f" }} />
                  </Box>
                  <Typography
                    variant="h6"
                    gutterBottom
...
NetworkTrainingPage.displayName = "NetworkTrainingPage";

export default NetworkTrainingPage;
