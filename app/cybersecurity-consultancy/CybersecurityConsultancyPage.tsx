// cybersecurity-consultancy/CybersecurityConsultancyPage.tsx
"use client";
...
const CybersecurityConsultancyPage: React.FC = React.memo(() => {
  return (
    <Box
      sx={{
...
CybersecurityConsultancyPage.displayName = "CybersecurityConsultancyPage";

export default CybersecurityConsultancyPage;
